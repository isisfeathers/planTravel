...
-- ==============================================================================
-- 9. 整合後端B所需之 RPC 函式 (TRACK2-06 原子性狀態寫回)
-- ==============================================================================

CREATE OR REPLACE FUNCTION public.complete_itinerary_job(
    p_itinerary_id UUID,
...
CREATE OR REPLACE FUNCTION public.fail_itinerary_job(
    p_itinerary_id UUID,
    p_error_code TEXT,
